...
public class StartRemotePeers {
    ...
    public static void main(String[] args) {
        ...
        String ciseUser = "zcowan"; // change with your CISE username
        ...
        peerList.add(new PeerInfo("1001", "lin114-01.cise.ufl.edu"));
        peerList.add(new PeerInfo("1002", "lin114-02.cise.ufl.edu"));
        peerList.add(new PeerInfo("1003", "lin114-03.cise.ufl.edu"));
        peerList.add(new PeerInfo("1004", "lin114-04.cise.ufl.edu"));
        peerList.add(new PeerInfo("1005", "lin114-05.cise.ufl.edu"));
        peerList.add(new PeerInfo("1006", "lin114-06.cise.ufl.edu"));
        peerList.add(new PeerInfo("1007", "lin114-07.cise.ufl.edu"));
        peerList.add(new PeerInfo("1008", "lin114-08.cise.ufl.edu"));
        peerList.add(new PeerInfo("1009", "lin114-09.cise.ufl.edu"));
        ...
        for (PeerInfo remotePeer : peerList) {
            try {
                 ...
                 */
                jsch.addIdentity("/Users/zacowan/.ssh/id_rsa", "");
